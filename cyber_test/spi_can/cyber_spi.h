#ifndef SPI_CAN_CYBER_SPI_H_
#define SPI_CAN_CYBER_SPI_H_
...
namespace {
const float kGearRatio = 1.f;
const float kDriverRatio = 1.f;
const float kKneeRatio = 1.f;
const float kTorqueCoefficient = 1.f;  // Nm/A
